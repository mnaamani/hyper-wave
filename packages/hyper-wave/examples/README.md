...
The pure-module examples (`ring`, `chord`, `token`, `flood`, `gallery`, `seeds`) run fully
offline and deterministically. `payments.js` derives its address offline but needs network (and a
