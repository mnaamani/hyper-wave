...
// NOTE: the engine ships NO concrete wallet — payments are pluggable. It exports the abstract
// `Wallet` interface + the wallet-agnostic fee flows (payments.js); a host adds a payment mechanism
// from a separate package (`hyperwave-wallet-cashu`, `hyperwave-wallet-tron`) and injects its
// factory via createEngine `deps.createPayments`.
module.exports = {
