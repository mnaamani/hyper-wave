// HyperWave desktop worker: the Electron host for the shared engine (lib/core.js). Started by
// the renderer via bridge.startWorker('/workers/hyperwave.js'); the storage dir arrives as
// Bare.argv[2] (see electron/main.js getWorker) and optional config via bare-env. A mobile
// react-native-bare-kit worklet (workers/worklet/app.js) hosts the SAME core over its own IPC +
// an init message instead — this file is the ~20-line desktop half of that seam.
